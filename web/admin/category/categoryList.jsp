...
<body>
	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<%--遍历显示用户数据数据--%>
		<c:forEach items="${pageInfo.pageList}" var="cc">
			<tr>
				<td height="30">
				<%--<input type="checkbox" name="checkbox" id="checkbox13">--%>
					<table width="100%" border="1" cellpadding="0" cellspacing="" bgcolor="#a8c7ce">
						<tbody>
						<tr>
							<td width="4%" height="20" bgcolor="#FFFFFF" class="STYLE10">
								<div align="center">
									<input type="checkbox" name="cid" value="1" onclick="checking()">
								</div>
							</td>
							<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
									<span class="STYLE10">${cc.cid}</span>
								</div>
							</td>
							<td width="15%" height="20" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
									<span class="STYLE10">${cc.cname}</span>
								</div>
							</td>
							<td width="14%" height="20" bgcolor="#FFFFFF" class="STYLE6">
								<div align="center">
									<div align="center" class="STYLE21">
										<a href="/admin/category/updateCategory.jsp?cid=${cc.cid}&amp;cname=${cc.cname}">编辑</a>
										|
										<a href="/admin/CategoryServlet?op=deleCategory&amp;cid=${cc.cid}&amp;cname=${cc.cname}">删除</a>
									</div>
								</div>
							</td>
						</tr>
							...
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategory&num=${pageInfo.previousPageNumber}">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategory&num=${pageInfo.nextPageNumber}">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategory&num=${pageInfo.totalPageNumber}">尾页</a></span>
										</div>
									</td>
	...
	<script type="text/javascript">
        ...
        function jump() {
            ...
            window.location.href = "${pageContext.request.contextPath}/admin/CategoryServlet?op=findAllCategory&num=" + num;
