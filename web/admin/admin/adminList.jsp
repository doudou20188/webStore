	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td><table width="100%" border="0" cellpadding="0"
					...
					<c:forEach items="${pageInfo.pageList }" var="admin">
						<tr>
						...
						<td height="20" bgcolor="#FFFFFF">
							<div align="center" class="STYLE21">
								 <a href="${pageContext.request.contextPath }/admin/AdminServlet?op=deleteOne&aid=${admin.aid}">删除</a> |
							...
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/AdminServlet?op=findAllAdmin&num=${pageInfo.previousPageNumber}">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/AdminServlet?op=findAllAdmin&num=${pageInfo.nextPageNumber}">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/admin/AdminServlet?op=findAllAdmin&num=${pageInfo.totalPageNumber }">尾页</a></span>
										</div>
									</td>
