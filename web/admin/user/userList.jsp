		...
		<tr>
			<td><table width="100%" border="0" cellpadding="0"
					...
					<c:forEach items="${pageInfo.pageList}" var="user">
						...
						<td width="10%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div
								align="center">
								<span class="STYLE10">${user.uid }</span>
							</div>
						</td>
						<td width="15%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div
								align="center">
						...
						<td width="14%" height="20" bgcolor="#FFFFFF" class="STYLE6"><div
								align="center">
							...
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/UserServlet?op=findAllUser&num=${pageInfo.previousPageNumber}">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/UserServlet?op=findAllUser&num=${pageInfo.nextPageNumber}">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/admin/UserServlet?op=findAllUser&num=${pageInfo.totalPageNumber }">尾页</a></span>
										</div>
									</td>
