...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
        	...
        	<img src="${product.imgurl }" style="width: 200px; height: 300px" /></a>
            </div>
            <div class="content_half float_r">
                <table>
                    ...
                    <tr>
                    	<td>购买数量:</td>
                        <td><input type="text" id="snum" name="snum" value="1" style="width: 20px; text-align: right" />&nbsp;库存:${product.pnum }</td>
                    </tr>
                </table>
