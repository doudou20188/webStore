    ...
    <div id="templatemo_wrapper">
        ...
        <div id="templatemo_menubar" style="position: relative;">
            ...
            <div id="templatemo_search" onmouseleave="dispear(document.getElementById('hintContent'))">
                <form action="${pageContext.request.contextPath }/WebProductServlet" method="get">
        ...
        <div id="templatemo_main">
            ...
            <div id="content" class="float_r">
                <div id="slider-wrapper">
                    <div id="slider" class="nivoSlider">
                        <c:forEach items="${topProducts}" var="product">
                            <a href="${pageContext.request.contextPath }/WebProductServlet?op=findProductsByName&pname=${product.pname}">
                ...
                <h3>热门商品</h3>
                <c:forEach items="${requestScope.hotProducts}" var="product" varStatus="vs">
                    <div class="${vs.index % 3 != 2?'product_box':'product_box no_margin_right' }">
                        <h3>${product.pname }</h3>
                        <a href="${pageContext.request.contextPath }/WebProductServlet?op=findProductByPid&pid=${product.pid}">
        ...
        <div id="templatemo_footer">
            Copyright (c) 2018 <a href="#">英雄联盟 皮肤商城</a> | <a href="#">爪洼岛工作室</a>
        </div>
    </div>
</div>
<script type="text/javascript">
